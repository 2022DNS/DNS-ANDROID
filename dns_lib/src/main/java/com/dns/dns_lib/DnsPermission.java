...
public class DnsPermission {
    ...
    public static boolean requestDnsPermissions(Context context, Activity activity, int requestCode) {
        ArrayList<String> permissions = new ArrayList<>(Arrays.asList(Manifest.permission.RECORD_AUDIO, Manifest.permission.CAMERA, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION));
